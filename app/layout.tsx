...
export const metadata: Metadata = {
  ...
  description: 'Raj Delight Restaurant in Chandausi. Explore the complete public menu, find the restaurant, and order online through Zomato or Swiggy.',
  ...
  openGraph: { title: 'Raj Delight | Chandausi', description: 'Explore the menu, discover the dining experience and order online.', type: 'website' },
};

export default function RootLayout({ children }: Readonly<{ children: React.ReactNode }>) {
  return <html lang="en"><body className={`${displayFont.variable} ${bodyFont.variable}`}>{children}</body></html>;
}
